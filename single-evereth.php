...
<setion class="workshops">
	<div class="grid-2 gap150 gap-50-2l grid-1-xxm">
		<div class="w-70p -m-0auto w-90p-xxl">
			...
			<h5 data-aos="fade-100" class="-mb-10">Dzień 1 - odkrywanie</h5>
			<p data-aos="fade-200" class="-mb-30">Podczas spotkań z zespołem Evereth oraz spotkań z przedstawicielami grup docelowych odbiorców portalu, zgromadziliśmy niezbędne wytyczne oraz określiliśmy najważniejsze cele związane z projektem strony.</p>
			<h5 data-aos="fade-100" class="-mb-10">Dzień 2 - warsztaty</h5>
			<p data-aos="fade-200">Przeprowadzone warsztaty koncepcyjne, pogłębione oraz warsztaty design thinking były jednym z najistotniejszych etapów współpracy. Dzięki nim określiliśmy wymagania dotyczące realizowanego serwisu.</p>
		</div>
		<img data-aos="fade-300" class="img1 b-radius15 b-shadow" src="https://ohsofresh.pl/wp-content/uploads/2022/11/user-experience.jpg" />
	</div>
	<div class="ta-center">
		<img data-aos="fade-400" class="img2 b-radius15 b-shadow" src="https://ohsofresh.pl/wp-content/uploads/2022/11/user-experience2.jpg" />
	</div>
</setion>

<!--- STEPS --->

<div class="steps -mt-n50 -pr-20 -pl-20" style="text-align:center; margin:0 auto;" data-aos="fade-100">
	<img class="d-none-xxm" src="https://ohsofresh.pl/wp-content/uploads/2023/01/warsztaty.svg" />
	<img class="ta-center -m-0auto d-none d-block-xxm" src="https://ohsofresh.pl/wp-content/uploads/2023/03/warsztaty.svg" />
</div>
...
if( $strategy ): ?>
<div id="strategy" class="container-1540 grid-2 gap100 items-c gap50-xl grid-1-l zindex999 -mt-100">
	<div class="content w-80p j-self-s w-100p-l">
		<h3 class="red -mb-10" data-aos="fade-50"><?php echo ( $strategy['header'] ); ?></h3>
		<p class="" data-aos="fade-100"><?php echo ( $strategy['txt'] ); ?></p>
	</div>
	<div class="img j-self-s-l" data-aos="fade-up">
		<img class="b-radius15 b-shadow" src="<?php echo esc_url( $strategy['img'] ); ?>" />
	</div>
</div>
<?php endif; ?>
...
<section class="relative ">
	<div class="container-1540 grid-2 grid-1-xxm">
		<div class="w-60p -pt-100 w-70p-xl w-100p-l">
			<h3 class="-mb-30" data-aos="fade-up">Ścieżka klienta</h3>
			<p class="" data-aos="fade-100">Bazując na dobrze zaplanowanej strategii, dobrze poznaliśmy odbiorców serwisu. Powstała, na podstawie warsztatów i person ścieżka Klienta zapewnia przemyślana nawigację.</p>
		</div>
	</div>
	<div class="cjou" data-aos="fade-200">
		<img src="https://ohsofresh.pl/wp-content/uploads/2023/01/evereth-customer.svg"/>
	</div>
</section>

<!--- NOWOCZESNE --->

<?php $modern = get_field('modern');

if( $modern ): ?>
<div id="modern" class="container-1540 grid-2 gap100 items-c -pt-70 gap50-xl grid-1-l zindex999">
	<div class="img j-self-s-l" data-aos="fade-up">
		<img class="b-radius15 b-shadow" src="<?php echo esc_url( $modern['img'] ); ?>" />
	</div>
	<div class="content w-80p j-self-s w-100p-l">
		<h3 class="red -mb-10" data-aos="fade-50"><?php echo ( $modern['header'] ); ?></h3>
		<p class="" data-aos="fade-100"><?php echo ( $modern['txt'] ); ?></p>
	</div>
</div>
<?php endif; ?>
...
<div class="-pt-100" style="text-align:center; margin:0 auto;">
	<img data-aos="fade-100" src="https://ohsofresh.pl/wp-content/uploads/2023/01/ev-ui.png" />
</div>
